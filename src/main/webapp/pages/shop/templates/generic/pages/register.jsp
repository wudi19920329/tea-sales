					...
					<div class="row">
						<div class=" col-lg-6 col-md-6 col-sm-8  col-xs-12">
							...
							<div class="login-form">
								<form method="post" action="/register?method=submit" id="registrationForm" class="form-signin required-validate">
									<div class="form-group login-page">
											<label for="realName">姓名 <span>*</span></label>
								   			<input name="realName" id="realName"  class="span8 required form-control form-control-md" 
								   			   />
									</div>
									<div class="form-group login-page">
											<label for="phone">手机号 <span>*</span></label>
								   			<input name="phone" id="phone"  class="span8 required form-control form-control-md" 
								   			   />
									</div>
									...
									<div class="form-group login-page">
										...
										<div style="position: relative;">
											<input id="address" name="address" class="form-control" readonly type="text"  data-toggle="city-picker">
										</div>
									</div>
									...
									<div class="form-group login-page">
										<label for="email">邮箱地址 <span>*</span></label>
							     		<input name="email" id="email" class="span8 required email form-control form-control-md"  />
									</div>								
									<div class="form-group login-page">
										<label for="password">密码<span>*</span></label>
							    		<input type="password" name="password" id="password" class="span8 required password form-control form-control-md"   />
									</div>							
									<div class="form-group login-page">
										<label for="confirmPassword">确认密码<span>*</span></label>
							     		<input type="password" name="confirmPassword" id="confirmPassword" class="span8 required checkPassword form-control form-control-md"  />
									</div>
									<button type="submit" id="subBtn" class="btn btn-default login-btn">创建账户</button>
								</form>				
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-4 hidden-xs">
								<h3 class="short_headline"><span>为什么注册</span></h3>
								<p>
									简化结算流程通过你的信息,再订购一个项目从一个产品链接
								</p>
