<%-- <%@page import="com.tea.dbHandle.UserHandle"%>
<%@page
	import="com.tea.dbHandle.GoodsHandle,com.tea.entity.*,com.tea.tools.*,java.util.*,java.text.*,com.tea.servlet.*"%>
<%/*
物品详情页，包含详情和操作按钮
*/%>
...
Integer goodsNum=0;
	...
	boolean isLogin =LoginVerify.isLogin(request);
	 ...
	 User Procuteuser=userHandle.queryByEmail(good.getProducter_id());
