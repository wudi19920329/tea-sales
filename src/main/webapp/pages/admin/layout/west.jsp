...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		  $.ajax({
	          type: 'GET',
	           dataType: "json",
	           url : '<%=request.getContextPath()%>/resources/admin-menusdata/parent_menus.json?parentId=1&isUserMenuTree=false',
	...
	function CreateMenuTree(mname,mid){
		$('#MenuTree-'+mid).tree({
			url : '<%=request.getContextPath()%>/resources/admin-menusdata/children_menus.json?parentId=' + mid+'&isUserMenuTree=true',
			method:'GET',
		    dataType: "json",
			animate : false,
